...
export type CamelCaseResource = Resource | 'purchaseOrder' | 'salesOrder' | 'getEntry' | 'setEntry' | 'getEntries' | 'getEntryList' | 'getUserId' | 'getUserProfile' | 'getAvailableModules' | 'getModuleFields';
